...
import AdminDashboardStatsCard from '~/components/Admin/Dashboard/StatsCard.vue'
import AdminDashboardWeeklyReservations from '~/components/Admin/Dashboard/WeeklyReservations.vue'
import AdminDashboardProgressChart from '~/components/Admin/Dashboard/ProgressChart.vue'
import AdminDashboardRecentBlogs from '~/components/Admin/Dashboard/RecentBlogs.vue'
import AdminDashboardVehicleCarousel from '~/components/Admin/Dashboard/VehicleCarousel.vue'

// Dashboard sections configuration
const defaultSections = ref([
  { id: 'stats', name: 'Statistics Cards', component: 'stats' },
  { id: 'reservations-progress', name: 'Reservations & Progress', component: 'reservations-progress' },
...
watch(dashboardSections, (newSections) => {
  if (process.client) {
  ...
  <div class="admin-dashboard p-6">
    ...
    >
      <template #item="{ element }">
        ...
        >
          <!-- Stats Cards Section -->
          <div v-if="element.component === 'stats'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div v-else-if="element.component === 'reservations-progress'" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <AdminDashboardWeeklyReservations />
            <AdminDashboardProgressChart />
          </div>
          
          <!-- Recent Blog Posts and Vehicle Carousel Section -->
          <div v-else-if="element.component === 'blogs-vehicles'" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
